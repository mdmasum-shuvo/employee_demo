package com.nuveq.sojibdemo.utils.custom_dialog.Activity;
...
public class SmartDialog {
    ...
    public SmartDialog(Context context, String title, int img, String subTitle, Typeface titleFont,
    ...
    private void initDialogViw() {
        ...
        imageView=dialog.findViewById(R.id.img_diluge);
